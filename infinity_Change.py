...
def Loop_Infinity(file_Path, pico_Number, max_Number):
    ############################################################################################
    ...
    max_Run_Number = max_Number # for my current situation 04/23/2019
    for run in range(1,max_Run_Number + 1):
        filename = (file_Path + "03102020pico" + 
                    str(pico_Number) + "/20200310-0001 (" + str(run) + ").txt")
...
##################################################################################
for pico in range(1, 9):
	Loop_Infinity(file_Path, pico_Number = pico, max_Number = 25)
